...
* **`Descriptive Modeling.ipynb`**: Unsupervised learning pipeline. Includes EDA, data cleaning, PCA, and **K-Means Clustering** to define lifestyle profiles.
...
* **Feature Enrichment:** Integrated external **GDP per capita** and **Population** data to contextualize behavioral patterns.
...
We utilized **Principal Component Analysis (PCA)** for dimensionality reduction and tested K-Means vs. Hierarchical Clustering across three profiles:
...
## 📊 Key Findings
* **Best Model:** **Gradient Boosting Classifier** achieved the highest accuracy and stability, effectively handling complex non-linear feature interactions.
* **Cluster Insights:**
...
* **Techniques:** Gradient Boosting, K-Means, PCA, Stratified Cross-Validation, Grid Search.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/Francisco772/WHO-LIFE-Analysis.git](https://github.com/Francisco772/WHO-LIFE-Analysis.git)
